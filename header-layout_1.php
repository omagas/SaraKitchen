                    ...
                    <?php if($show_header == 'header_logo_only') : ?>
                        <?php if(get_header_image()) : ?>
                            <div class="header-logo-container">
                                <h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="http://www.sarasdiyhealth.com/test2/wp-content/uploads/2016/05/cropped-index-final-01_031-1.jpg" /></a></h1>
                            </div>
                        <?php endif; ?>
