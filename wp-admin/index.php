...
li#menu-posts-essential_grid {
    display: none;
}
li#menu-posts-custom-video-feat {
    display: none;
}
li#menu-posts-custom-client-logo {
    display: none;
}
li#menu-posts-custom-testimonial {
    display: none;
}
li#menu-posts-custom-team {
    display: none;
}
li#menu-posts-custom-service {
    display: none;
}
li#menu-posts-custom-faq {
    display: none;
}
li#menu-posts-custom-portfolio {
    display: none;
}
</style>
<?php
