        ...
        <div class="featured-video-wrapper-block clearfix">
            <div class="feature_video_section clearfix">
                ...
                <div class="feat_video">
                    <?php echo do_shortcode('[video src="http://www.youtube.com/watch?v=0A_nK1h3RzY" autoplay="off"][/video]');  ?>
                </div>
...
?>
    ...
    <div class="media">
        ...
        <div class="media-left">
            <a href="#">
              aaa<? //_ayvpp_video_url : http://www.youtube.com/watch?v=0A_nK1h3RzY
