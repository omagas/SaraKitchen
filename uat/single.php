	...
	<main id="main" class="site-main <?php echo $aglee_pro_content_class; ?>" role="main">
        ...
        <div class="ap-container">
            ...
            <?php endif; ?>
                ...
                <!--hao 文章內容也要加title-->
                <div class="inner-post-title"><?php the_title(); ?></div>
                <div class="inner-post-date"><?php echo get_the_date('M j,Y');?></div>
            ...
            <div class="col-md-12">            
            <div class="previous-link"><?php previous_post_link("上一篇: %link","%title", true); ?></div>
            <div class="next-link"><?php next_post_link("下一篇: %link","%title", true); ?></div> 
            </div>

            <div class="single-post-return">  
                <a href="http://www.sarasdiyhealth.com/uat01/%E6%96%87%E7%AB%A0/">>>回到文章列表<<</a>
            </div>
